      ...
      <div style={{
        ...
        <div style={{ padding: '40px 32px' }}>
          ...
          <p style={{
            ...
            Чтобы начать работу в mestoX и подключить ваши TMS-системы, подтвердите адрес электронной почты.
          </p>

          {/* CTA Button */}
          <a
            href="https://mestox.ru/confirm?token=EXAMPLE_TOKEN"
            style={{
          ...
          <div style={{
            ...
            <a href="https://mestox.ru/confirm?token=EXAMPLE_TOKEN" style={{
              fontSize: '11px',
              color: C.blue,
              wordBreak: 'break-all',
              fontFamily: 'monospace',
            }}>
              https://mestox.ru/confirm?token=EXAMPLE_TOKEN_123456
            </a>
          </div>
          ...
          <div style={{
            ...
            Если вы не регистрировались в mestoX, просто проигнорируйте это письмо.
          </div>
        </div>
